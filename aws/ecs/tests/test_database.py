...
class TestUnitDatabase:
    ...
    @pytest.fixture
    def mock_database_object(self) -> Database:
    ...
    def test_get_table(self, mock_database_object: Database) -> None:
    ...
    def test_table_exists(self, mock_database_object: Database) -> None:
    ...
    def test_create_table(self, mock_database_object: Database) -> None:
    ...
    def test_table_exists_exception(self, mock_database_object: Database) -> None:
    ...
    def test_populate_test_data(self, number_of_items: int, mock_database_object: Database) -> None:
